...
public class ActionListenersTutorialClass extends JPanel 
    ...
    public ActionListenersTutorialClass() {
    ...
    private static void createAndShowGUI() {
        ...
        JComponent newContentPane = new ActionListenersTutorialClass();
...
class Eavesdropper implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        myTextArea.append(e.getActionCommand()
                        + ActionListenersTutorialClass.newline);
