...
public class StoneMine extends Building{
	...
	public StoneMine(MainClass mc, int x, int y, Field f) {
		super(x,y,f,mc);
		currentSprite=Toolkit.getDefaultToolkit().getImage("Images/buildings/StoneMine.png");
	}
	
	@Override
	public void turnUpdate(int turn) {
		if (owner != null) {
			owner.getStone().addAmount(2);
		}
	}
